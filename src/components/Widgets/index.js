...
const Euro2RialAreaChart = Loadable({
   loader: () => import("./Euro2RialAreaChart"),
   loading: MyLoadingComponent
})

const USD2RialAreaChart = Loadable({
   loader: () => import("./USD2RialAreaChart"),
   loading: MyLoadingComponent
})

const SEK2RialAreaChart = Loadable({
   loader: () => import("./SEK2RialAreaChart"),
   loading: MyLoadingComponent
})
